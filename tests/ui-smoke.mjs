...
await page.addInitScript(() => {
  const server = {
    ...
    enableSpeculativeOptions: true, specType: "", specDraftTypeK: "", specDraftTypeV: "", specDraftNMax: 0, specDraftNMin: 0,
    ...
    preserveThinking: true, reasoningPreserve: "flag", reasoningFormat: "", reasoningBudget: "",
    chatTemplateKwargs: "", reasoning: "", enableMultimodalOptions: true,
